...
public class ApplicationConfiguration {
	...
	public OpenAPI customOpenAPI() {
		return new OpenAPI().components(new Components()).info(new Info().title("Flight Management System")
				.description("The Airport Management System allows airlines, passengers, and staff to manage flights, booking details, luggage, and other airport-related tasks efficiently. "
